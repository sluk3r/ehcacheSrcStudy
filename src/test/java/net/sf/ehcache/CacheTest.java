 ...
 * @version $Id: CacheTest.java 7979 2013-08-15 14:46:18Z cdennis $
 */
public class CacheTest extends AbstractCacheTest {
    ...
    public void testUseCacheAfterManagerShutdown() throws CacheException {
        //wangxc，只看名字以为是Shutdown后还能用呢， 这样的测试总觉得白费。
    ...
    public void testCantSwitchPool() throws Exception {
        ...
        CacheConfiguration cacheConfiguration = new CacheConfiguration("one", 0);//wangxc 这里的CacheConfiguration跟Configuration的关系？
    ...
    @Test(expected = InvalidConfigurationException.class) //wangxc， expected第一次用， 是说如果不抛这个异常， 就是错。
    public void testLocalHeapCantSwitchToCountBased() {
        ...
        sizeBased.getCacheConfiguration().setMaxEntriesLocalHeap(100);//wangxc 从功能上说， 为什么不能这样设置？
    }
    ...
    public void testSetCacheName() throws CacheException {
        ...
        cache.setName("name/with/slash");//wangxc 能不能用点分隔？
